...
public class PlaneacionDAO {
   ...
   public PlaneacionDAO(){
       databaseConnection = new DataBaseConnection();
       
   }
   
   public int insertPlaneacion(Planeacion planeacion){
       int affectedRows = 0;
       connection = databaseConnection.getConnection();
       String query = "insert into planeacion(idPlanCurso, unidad, tema, fechas, tarea, tecnica) values (?,?,?,?,?,?);";
       try{
          PreparedStatement preparedStatement = connection.prepareStatement(query);
          preparedStatement.setInt(1, planeacion.getIdPlanCurso());
          preparedStatement.setInt(2, planeacion.getUnidad());
          preparedStatement.setString(3, planeacion.getTema());
          preparedStatement.setString(4, planeacion.getFechas());
          preparedStatement.setString(5, planeacion.getTarea());
          preparedStatement.setString(6, planeacion.getTecnica());
   ...
   public Planeacion getPlaneacion(int idPlaneacion){
       PlanCurso planCurso = null;
       connection = databaseConnection.getConnection();
       String query = "Select * from planeacion where idPlaneacion = ?";
       try{
           PreparedStatement preparedStatement = connection.prepareStatement(query);
           preparedStatement.setInt(1, idPlaneacion);
